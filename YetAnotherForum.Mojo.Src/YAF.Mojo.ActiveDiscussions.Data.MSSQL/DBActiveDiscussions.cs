...
namespace mojoPortal.Data
{
    ...
    public static class DBActiveDiscussions
    {
        ...
        public static int Create(
            ...
            DateTime created)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "mp_Currency_Insert", 11);
        ...
        public static bool Update(
            ...
            DateTime lastModified)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "mp_Currency_Update", 10);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 50, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@Code", SqlDbType.NChar, 3, ParameterDirection.Input, code);
            sph.DefineSqlParameter("@SymbolLeft", SqlDbType.NVarChar, 15, ParameterDirection.Input, symbolLeft);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "mp_Currency_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "mp_Currency_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
        ...
        /// </summary>
        public static IDataReader GetAll(Guid guid, string settingName)
        {
        ...
        /// Gets an IDataReader with all rows in the mp_Currency table.
        /// </summary>
        public static IDataReader GetAll(string srcPath, string settingName)
        {
